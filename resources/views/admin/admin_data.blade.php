...
<script src="{{ asset("AdminLTE/plugins/jszip/3.1.5/jszip.min.js") }}"></script>
...
$(document).ready(function() {
	...
	$('#query').click(function(){
        ...
        $.get('/admin/data/ajaxdata/{{$pid}}?stime='+stime+'&etime='+etime,function(ajaxdata){
            ...
            $tableConfig={
                "destroy": true,
                // "ajax" :'/admin/data/ajaxdata/{{$pid}}?stime='+stime+'&etime='+etime,
                "data":ajaxdata.data,
