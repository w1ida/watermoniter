...
<head>
   ...
   -->
    ...
    <!--[if lt IE 9]>
    <script src="{{ asset("AdminLTE/plugins/html5shiv.min.js") }}"></script>
    <script src="{{ asset("AdminLTE/plugins/respond.min.js") }}"></script>
...
<!-- Layer 3.1.1-->
<script src="{{ asset("plugins/layer-v3.1.1/layer/layer.js") }}"></script>
