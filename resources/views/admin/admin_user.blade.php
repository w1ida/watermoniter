            ...
            <div class="box-body">
              <table class="table table-bordered">
                ...
                <tr>
				  ...
				  <td>
					<div class="btn-group">
					  <button type="button" class="btn btn-xs btn-info editUser" data-userid="{{ $userRow->id }}"><i class="fa fa-edit"></i>编辑</button>
					  <button type="button" class="btn btn-info btn-xs dropdown-toggle" data-toggle="dropdown">
						<span class="caret"></span>
						<span class="sr-only">Toggle Dropdown</span>
					  </button>
					  <ul class="dropdown-menu " style="min-width:0px;" role="menu">
                          <li ><a class="text-red deluser" href="#" data-userid="{{ $userRow->id }}" ><i class="fa fa-remove"></i>删除</a></li>
					  </ul>
					</div>
				  </td>
                </tr>
        ...
        layer.open({
            ...
            success :function(){
                ...
                $('#adduser_do').click(function() {
                    $.post(location.pathname,{_method:'post',_token:'{{csrf_token()}}',data:{email:$('#edit_email').val(),
                ...
                layer.open({
                    ...
                    success :function(){
                        ...
                        $('#edit_do').click(function() {
                            $.post(location.pathname+'/'+useId,{_method:'put',_token:'{{csrf_token()}}',data:{email:$('#edit_email').val(),
                            name:$('#edit_username').val(), password: $('#edit_pwd').val()},
                            },function(data){
                                console.log(data);
                                layer.msg(data.msg,{icon: data.code==0?1:2,time:1500},function () {
