...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(asset("AdminLTE/plugins/font-awesome-4.7.0/css/font-awesome.min.css")); ?>">
    <!-- Ionicons -->
    <link rel="stylesheet" href="<?php echo e(asset("AdminLTE/plugins/ionicons-2.0.1/css/ionicons.min.css")); ?>">
            ...
            <div class="form-group">
                ...
                <div class="col-xs-8">
                    <div class="checkbox icheck">
                        <label>
                            <input type="checkbox" name="remember"><?php echo e(trans('auth.rememberme')); ?>
