<?php $__env->startSection('title','数据分析'); ?>
<?php $__env->startSection('title_desc','数据分析'); ?>
...
<script src="<?php echo e(asset("libs/js/echarts.min.js")); ?>"></script>
...
$('#query').click(function(){
	...
	$.ajax({
		type: "GET",
		url: "/admin/data/ajaxanalysis/<?php echo e($pid); ?>",
