<?php $__env->startSection('title','地图显示'); ?>
...
//        $('.BMap_mask').remove();
        ...
        map.centerAndZoom(new BMap.Point(<?php echo e($points[0]->lng); ?>,<?php echo e($points[0]->lat); ?>), 12);
        var data_info = [
            <?php $__currentLoopData = $points; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $point): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
				[<?php echo e($point->lng); ?>,<?php echo e($point->lat); ?>,'<?php echo e($point->pname); ?>',<?php echo e($point->pid); ?>,'<?php echo e($point->area->aname); ?>',<?php echo e($point->aid); ?>],
...
//            [112.921228,28.200334,"梅溪湖",29]
        ...
        function t(){
            try{
                ...
                map.centerAndZoom(new BMap.Point(<?php echo e($points[0]->lng); ?>,<?php echo e($points[0]->lat); ?>), 8);
            }catch(e){
                setTimeout(t,50);
            }
        }
